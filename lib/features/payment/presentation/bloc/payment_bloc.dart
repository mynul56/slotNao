...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  PaymentBloc({
    required InitPaymentUseCase initPaymentUseCase,
  ...
  Future<void> _onInit(
    PaymentInitRequested event,
    Emitter<PaymentState> emit,
  ) async {
    emit(const PaymentLoading());
    final result = await _initPaymentUseCase(InitPaymentParams(
  ...
  Future<void> _onConfirm(
    ...
    emit(const PaymentLoading());
    final result = await _confirmPaymentUseCase(ConfirmPaymentParams(
