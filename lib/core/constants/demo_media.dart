class DemoMedia {
  ...
  static const List<String> turfImages = [
    ...
    'https://images.unsplash.com/photo-1562552052-2b43e7f32210?auto=format&fit=crop&w=1400&q=80',
  ];

  static const List<String> playerImages = [
    ...
    'https://images.unsplash.com/photo-1553778263-73a83bab9b0c?auto=format&fit=crop&w=1000&q=80',
  ];
